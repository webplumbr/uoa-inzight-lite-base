...
RUN  R -e "install.packages('iNZightTools', repos = 'https://r.docker.stat.auckland.ac.nz/src/contrib/')" \
 && R -e "install.packages('iNZightMR', repos = 'https://r.docker.stat.auckland.ac.nz/src/contrib/')" \
 && R -e "install.packages('iNZightPlots', repos = 'https://r.docker.stat.auckland.ac.nz/src/contrib/')" \
 && R -e "install.packages('iNZightMaps', repos = 'https://r.docker.stat.auckland.ac.nz/src/contrib/')" \
