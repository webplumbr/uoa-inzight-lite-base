...
ENV LAST_BUILD_DATE "Mon 11 06 21:45:00 NZDT 2020"

# Install (via R) all of the necessary packages (R will automatially install dependencies):
RUN  R -e "install.packages('https://r.docker.stat.auckland.ac.nz/src/contrib/iNZightPlots_2.11.6.tar.gz', repos = NULL, type = 'source', dependencies = TRUE)" \
